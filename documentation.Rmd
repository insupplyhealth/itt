...
### Calculation
$$\text{SOR (%) } = \frac{\text{Total number of facilities that reported zero ending balance this month}}{\text{Total number of facilities that provided the product in the last 12 months}} * 100$$
